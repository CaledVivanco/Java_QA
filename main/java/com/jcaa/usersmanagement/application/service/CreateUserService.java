//Hace TODO en un método (violación Regla 1)
//Mezcla niveles de abstracción
//Construye el dominio manualmente
//Tiene validación dentro del service
...
public final class CreateUserService implements CreateUserUseCase {
    ...
    public UserModel execute(final CreateUserCommand command) {
        ...
        final UserModel user = mapper.toModel(command);

        final UserModel savedUser = saveUserPort.save(user);
