...
public final class Main {
    ...
    private static void runApplication(final DependencyContainer container) {
        try (final Scanner scanner = new Scanner(System.in)) {
            ...
            final ConsoleIO consoleIO = buildConsoleIO(scanner);
    ...
    private static ConsoleIO buildConsoleIO(final Scanner scanner) {
    ...
    private static UserManagementCli buildCli(
        ...
        return new UserManagementCli(
                container.userController(),
                consoleIO);
    }
}// solucion Usamos @Log → consistente con todo el proyecto,ahora cada metodo tiene una funcion